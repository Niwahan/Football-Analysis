...
class ViewTransformer():
    def __init__(self):
        ...
        self.traget_vertices = self.traget_vertices.astype(np.float32)
        
        self.perspective_transformer = cv2.getPerspectiveTransform(self.pixel_verticies, self.traget_vertices)
